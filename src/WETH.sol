...
contract WETH is IERC20 {
    ...
    function _mint(uint256 amount, address owner) private {
    ...
    function _checkBalance(address _address, uint256 _value) private view {
        require(this.balanceOf(_address) >= _value, "You don't have enough WETH.");
    }

    function _transfer(address _from, address _to, uint256 _value) private {
        require(balances[_from] >= _value, "The adress dosen't have enough WETH.");
